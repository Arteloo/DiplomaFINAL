...
import { updateRef } from '../../http/RefAPI';
import { useParams } from 'react-router-dom';

const UpdateRef = observer(({show, onHide}) => {
    const {id} = useParams()
    ...
    const UpdRef = () => {
        ...
        updateRef(id, formData).then(data => 
    ...
    >
      ...
      <Modal.Footer>
        <Button variant='outline-success' onClick={UpdRef}>Сохранить</Button>
